...
var UnityView = /** @class */ (function (_super) {
    ...
    UnityView.prototype.componentWillUnmount = function () {
        var unloadOnUnmount = this.props.unloadOnUnmount;
        UnityModule_1.UnityModule.removeMessageListener(this.state.handle);
        if (unloadOnUnmount) {
            UnityModule_1.UnityModule.unloadPlayer();
        }
    };
...
*/
NativeUnityView = (0, react_native_1.requireNativeComponent)('RNUnityView', UnityView);
